...
t_track=69 # 11, 393, 406 is right before a goal, 221 passer not in view
...
pdf("C:/Users/Paula/Desktop/Big-Data-Cup-2022-Private/images/angle_track69.pdf")
point_val[[2]]
dev.off()
```

```{r}
pdf("C:/Users/Paula/Desktop/Big-Data-Cup-2022-Private/images/fullpass_track69.pdf")
...
```{r}
pdf("C:/Users/Paula/Desktop/Big-Data-Cup-2022-Private/images/successful_pass_prob_track69.pdf") 
plot_half_rink(p11)
dev.off()
```
