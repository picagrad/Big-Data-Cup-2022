...
source("F:/Hockey/Current Git/Big-Data-Cup-2022-Private/code/visualization/hockey_pipeline.R")
setwd("F:/Hockey/Current Git/Big-Data-Cup-2022-Private")
...
save(pass_speed, file="F:/Hockey/Current Git/Big-Data-Cup-2022-Private/data/pass_model_5speeds.Rdata")
...
save(combine_dat, file="F:/Hockey/Current Git/Big-Data-Cup-2022-Private/data/combine_data.Rdata")
...
save(quant_rank, file="F:/Hockey/Current Git/Big-Data-Cup-2022-Private/data/quant_columns.Rdata")
...
save(pass_speed2, file="F:/Hockey/Current Git/Big-Data-Cup-2022-Private/data/pass_model_5speeds_quantile.Rdata")
```
...
```{r}
save(current_event, file="F:/Hockey/Current Git/Big-Data-Cup-2022-Private/data/pass_summary.Rdata")
```

```{r}
load("F:/Hockey/Current Git/Big-Data-Cup-2022-Private/data/pass_model_5speeds.Rdata")
load("F:/Hockey/Current Git/Big-Data-Cup-2022-Private/data/pass_summary.Rdata")
```
