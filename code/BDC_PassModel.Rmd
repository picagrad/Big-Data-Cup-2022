...
source("Big-Data-Cup-2022-Private/code/visualization/hockey_pipeline.R")
setwd("Big-Data-Cup-2022-Private")
...
save(pass_speed, file="Big-Data-Cup-2022-Private/data/pass_model_4speeds.Rdata")
```
...
```{r}
save(current_event, file="Big-Data-Cup-2022-Private/data/pass_summary.Rdata")
```
